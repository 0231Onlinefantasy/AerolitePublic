            ...
            if (hover) {
                ...
                try {
                    ...
                    infolist.forEachIndexed{index , it ->
                        ...
                        font.drawString(infolist[index], 1.5f,-(14f * infolist.size) + posy,if(ColorUtils.stripColor(infolist[index]) == currentitem.displayName) -1 else Color(175 ,175 ,175).rgb, true)
