...
class Radar : Element() {
    ...
    private val bordRad = FloatValue("BorderRadius", 10F, 0F, 10F)
    ...
    private val rainbowList = ListValue("Line-Rainbow", arrayOf("Off", "CRainbow", "Sky", "LiquidSlowly", "Fade"), "Off")
    ...
    override fun drawElement(partialTicks: Float): Border? {
        ...
        if (exhiValue.get())
            ...
            RenderUtils.drawRoundedRect(0F, 0F, size, size,bordRad.get(), Color(backgroundRedValue.get(), backgroundGreenValue.get(),
            ...
            for (i in 0..(gradientAmountValue.get()-1)) {
                ...
                RenderUtils.drawGradientSideways(barStart, -1.0, barEnd, 0.0,
                    when (rainbowType) {
                        ...
                        "LiquidSlowly" -> Colors.LiquidSlowly(System.nanoTime(), i * distanceValue.get(), saturationValue.get(), brightnessValue.get())!!.rgb
                    ...
                    when (rainbowType) {
                        ...
                        "LiquidSlowly" -> Colors.LiquidSlowly(System.nanoTime(), (i + 1) * distanceValue.get(), saturationValue.get(), brightnessValue.get())!!.rgb
        ...
        if (borderValue.get()) {
            ...
            // vertical
            RenderUtils.drawRoundedRect(halfSize - strength, 0F, halfSize + strength, size,bordRad.get(), borderColor)

            // horizontal
            RenderUtils.drawRoundedRect(0F, halfSize - strength, halfSize - strength, halfSize + strength,bordRad.get(), borderColor)
            RenderUtils.drawRoundedRect(halfSize + strength, halfSize - strength, size, halfSize + strength,bordRad.get(), borderColor)
