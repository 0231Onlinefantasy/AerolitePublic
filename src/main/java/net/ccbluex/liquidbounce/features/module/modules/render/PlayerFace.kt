...
class PlayerFace : Module() {
    private val modeValue = ListValue("Mode", arrayOf("TaiJun", "Yaoer", "XiaoZhao", "Blake"), "Yaoer")
    private var yaoer = ResourceLocation("aerolite/error/yaoer.png")
    private val taijun = ResourceLocation("aerolite/error/taijun.png")
    private val xiaozhao = ResourceLocation("aerolite/error/xiaozhao.png")
    private val blake = ResourceLocation("aerolite/error/blake.png")
