...
public final class Render extends MinecraftInstance {
    ...
    public static void renderRoundedRect(float x, float y, float width, float height, float radius, int color) {
        Render.drawGoodCircle(x + radius, y + radius, radius, color);
        Render.drawGoodCircle(x + width - radius, y + radius, radius, color);
        Render.drawGoodCircle(x + radius, y + height - radius, radius, color);
        Render.drawGoodCircle(x + width - radius, y + height - radius, radius, color);
