...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void drawGradientSidewaysV(double left, double top, double right, double bottom, int col1, int col2) {
        ...
        GL11.glPushMatrix();
        GL11.glBegin(7);
        GL11.glColor4f((float) f1, f2, (float) f3, (float) f);
    ...
    public static void quickDrawHead(@NotNull ResourceLocation skin, int i, int i1, int i2, int i3) {

    }

    public static void drawScaledCustomSizeModalCircle(int i, int i1, float fl, float fl1, int i2, int i3, int i4, int i5, float fl2, float fl3) {

    }

    public static void drawHead(@Nullable ResourceLocation locationSkin, int i, int i1, int i2, int i3) {
    ...
    public static void drawBlockBox(@NotNull BlockPos pos, @NotNull Color color, boolean b, boolean b1, float get) {
